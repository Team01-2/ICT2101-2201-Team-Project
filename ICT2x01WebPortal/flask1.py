...
def saveMap(mapData):
    ...
    index = mapData['index']
    if 1 <= index <= 3:
        createMap(index, mapData)
    else:
        return "Map saved unsuccessfully"
...
def deleteMap(mapData):
    global name1, name2, name3, mapArray1, mapArray2, mapArray3, startPoint1, startPoint2, startPoint3, endPoint1, endPoint2, endPoint3
    mapData = json.loads(mapData)
    index = mapData['index']
    if index == 1:
        ...
        return "Map deleted unsuccessfully"
    return "Map deleted successfully"


def createMap(index, mapData):
    global name1, name2, name3, mapArray1, mapArray2, mapArray3, startPoint1, startPoint2, startPoint3, endPoint1, endPoint2, endPoint3
    if index == 1:
        name1 = mapData['name']
        ...
        return "Map created unsuccessfully"
